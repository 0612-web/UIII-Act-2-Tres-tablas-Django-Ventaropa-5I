...
Haz clic en Ver (en la barra superior de VS Code).

Selecciona Terminal.

También puedes usar el atajo de teclado `Ctrl + `` (el acento grave, al lado del número 1).
...
Haz clic en el nombre del intérprete de Python en la parte inferior izquierda de la ventana de VS Code.

Selecciona .venv (el entorno virtual que creaste) de la lista de intérpretes.
